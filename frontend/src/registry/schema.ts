...
export const boardFields: StyleFieldDraft[] = [
  ...
  { key: 'boardBackgroundColor', label: '底板背景', type: 'color', group: '底板框' },
  { key: 'boardBorderColor', label: '边框颜色', type: 'color', group: '底板框' },
  { key: 'boardBorderWidth', label: '边框宽度', type: 'number', min: 0, max: 4, step: 1, unit: 'px', group: '底板框' },
  { key: 'boardRadius', label: '圆角', type: 'number', min: 0, max: 32, step: 2, unit: 'px', group: '底板框' },
  { key: 'boardTitleColor', label: '标题颜色', type: 'color', group: '底板框' },
  { key: 'boardTitleSize', label: '标题字号', type: 'number', min: 10, max: 32, step: 1, unit: 'px', group: '底板框' },
  { key: 'boardTitleAccentColor', label: '标题装饰条', type: 'color', group: '底板框' },
  { key: 'textColor', label: '正文颜色', type: 'color', group: '底板框' },
  { key: 'valueColor', label: '数值颜色', type: 'color', group: '底板框' },
  { key: 'showPeriodTabs', label: '周期切换', type: 'switch', group: '附属展示' },
  { key: 'activePeriodTab', label: '当前周期', type: 'select', group: '附属展示', options: [
    { label: '日', value: '日' }, { label: '月', value: '月' }, { label: '年', value: '年' },
  ] },
  { key: 'showDateRange', label: '日期范围', type: 'switch', group: '附属展示' },
  { key: 'dateRangeLabel', label: '日期标签', type: 'text', group: '附属展示' },
  { key: 'dateStartText', label: '开始日期', type: 'text', group: '附属展示' },
  { key: 'dateEndText', label: '结束日期', type: 'text', group: '附属展示' },
  { key: 'actionText', label: '右侧操作文字', type: 'text', group: '附属展示' },
  { key: 'showDemoTooltip', label: '演示提示框', type: 'switch', group: '附属展示' },
  { key: 'tooltipTitle', label: '提示框标题', type: 'text', group: '附属展示' },
  { key: 'tooltipPrimaryValue', label: '提示值一', type: 'text', group: '附属展示' },
  { key: 'tooltipSecondaryValue', label: '提示值二', type: 'text', group: '附属展示' },
];
