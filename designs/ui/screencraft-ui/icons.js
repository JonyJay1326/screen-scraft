/* icons.js — Lucide 内联 SVG 图标（唯一图标来源，禁止 emoji / 其他图标库）
   用法一：<i data-icon="search" data-size="16"></i>（DOMContentLoaded 自动替换）
   用法二：JS 中 icon('search', 16) 返回 SVG 字符串 */
(function () {
  var P = {
    ...
    'align-vertical': '<rect width="10" height="6" x="7" y="2" rx="1"/><rect width="16" height="6" x="4" y="16" rx="1"/><path d="M2 12h20"/>',
    'align-horizontal': '<rect width="6" height="10" x="2" y="7" rx="1"/><rect width="6" height="16" x="16" y="4" rx="1"/><path d="M12 2v20"/>',
    'distribute-vertical': '<rect width="18" height="6" x="3" y="3" rx="1"/><rect width="18" height="6" x="3" y="15" rx="1"/><path d="M3 12h18"/>',
    ...
    'cpu': '<rect width="16" height="16" x="4" y="4" rx="2"/><rect width="6" height="6" x="9" y="9"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="M7 2v2"/><path d="M17 2v2"/><path d="M7 20v2"/><path d="M17 20v2"/>'
  };
  ...
  function mount(root) {
    (root || document).querySelectorAll('[data-icon]').forEach(function (el) {
      ...
      tmp.innerHTML = window.icon(name, size);
      var svg = tmp.firstChild;
      svg.style.verticalAlign = 'middle';
      svg.style.flexNone = 'none';
      el.replaceWith(svg);
    });
  }
